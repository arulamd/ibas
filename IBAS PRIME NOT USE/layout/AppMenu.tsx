...
const AppMenu = () => {
    ...
    useEffect(() => {
        const loadMenu = async () => {
            try {
                ...
                const response = await axios.get('/api/getMenus', {
                    params: {
                        usercode: 'PARDO',
                        companycode: 'COMCL',
                        divisioncode: 'NCRNT'
                ...
                // const menu:AppMenuItem[] = await axios.get('/api/getMenus', {
                //     params: {
                //         usercode: 'PARDO',
                //         companycode: 'COMCL',
                //         divisioncode: 'NCRNT'
                //     },
                // });
                const menu: AppMenuItem[] = response.data || []; // adjust if needed
    ...
    //                 items: [
    //                     {
    //                         label: 'User Master', icon: 'pi pi-fw pi-circle', to: '/systemManagement/SM101' 
    //                     },
    //                     {
